package com.jetpack.example.data

import android.content.Context
import androidx.room.Room
import com.jetpack.example.data.repository.SmartSuggestionsRepository
import com.jetpack.example.data.repository.SmartSuggestionsRepositoryImp
import com.jetpack.example.data.repository.StoreRepository
import com.jetpack.example.data.repository.StoreRepositoryImp
...
import com.jetpack.example.data.room.StoreFinderDatabase
import com.jetpack.example.data.room.dao.SmartSuggestionsDao
import com.jetpack.example.data.room.dao.StoreDao
